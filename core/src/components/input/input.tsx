...
import { Build, Component, Element, Host, Method, Prop, State, Watch, forceUpdate, h } from '@stencil/core';
import type { NotchController } from '@utils/forms';
import { createNotchController } from '@utils/forms';
import type { Attributes } from '@utils/helpers';
import { inheritAriaAttributes, inheritAttributes, componentOnReady } from '@utils/helpers';
...
export class Input implements ComponentInterface {
   ...
   */
  private emitValueChange(_: Event) {
    //const { value } = this;
   ...
   */
  private emitInputChange(_?: Event) {
    //const { value } = this;
